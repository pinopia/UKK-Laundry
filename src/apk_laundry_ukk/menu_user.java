...
public class menu_user extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (tabel_user.getColumnModel().getColumnCount() > 0) {
            tabel_user.getColumnModel().getColumn(0).setHeaderValue("Title 1");
            tabel_user.getColumnModel().getColumn(1).setHeaderValue("Title 2");
            tabel_user.getColumnModel().getColumn(2).setHeaderValue("Title 3");
            tabel_user.getColumnModel().getColumn(3).setHeaderValue("Title 4");
        }

        jLabel6.setFont(new java.awt.Font("Serif", 1, 14)); // NOI18N
        jLabel6.setText("ROLE");

        combo_role.setFont(new java.awt.Font("Serif", 1, 14)); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(combo_role, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(32, 32, 32)))))
                .addContainerGap())
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(text_idoutlet, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        // TODO add your handling code here:
         try{
            this.stat = k.getCon().prepareStatement("update tb_user " + "set nama=?, username=?, password=?, role=? where id_user=?");
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        // TODO add your handling code here:
         try{
            stat = k.getCon().prepareStatement("delete from tb_user" + " where id_user=?");
